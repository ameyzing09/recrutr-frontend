...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  const wrapWithConnect = (WrappedComponent) => {
    ...
    function ConnectFunction(props) {
      const [propsContext, reactReduxForwardedRef, wrapperProps] = (0, import_react4.useMemo)(() => {
        const {
      ...
      const ContextToUse = (0, import_react4.useMemo)(() => {
        return propsContext && propsContext.Consumer && // @ts-ignore
        (0, import_react_is.isContextConsumer)(import_react4.default.createElement(propsContext.Consumer, null)) ? propsContext : Context;
      }, [propsContext, Context]);
      const contextValue = (0, import_react4.useContext)(ContextToUse);
      ...
      const childPropsSelector = (0, import_react4.useMemo)(() => {
        return finalPropsSelectorFactory(store.dispatch, selectorFactoryOptions);
      }, [store]);
      const [subscription, notifyNestedSubs] = (0, import_react4.useMemo)(() => {
        if (!shouldHandleStateChanges)
      ...
      const overriddenContextValue = (0, import_react4.useMemo)(() => {
      ...
      const lastChildProps = (0, import_react4.useRef)();
      const lastWrapperProps = (0, import_react4.useRef)(wrapperProps);
      const childPropsFromStoreUpdate = (0, import_react4.useRef)();
      const renderIsScheduled = (0, import_react4.useRef)(false);
      const isProcessingDispatch = (0, import_react4.useRef)(false);
      const isMounted = (0, import_react4.useRef)(false);
      const latestSubscriptionCallbackError = (0, import_react4.useRef)();
      useIsomorphicLayoutEffect(() => {
      ...
      const actualChildPropsSelector = (0, import_react4.useMemo)(() => {
        const selector = () => {
      ...
      const subscribeForReact = (0, import_react4.useMemo)(() => {
...
`;
      ...
      const renderedWrappedComponent = (0, import_react4.useMemo)(() => {
        return (
          // @ts-ignore
          import_react4.default.createElement(WrappedComponent, _extends({}, actualChildProps, {
            ref: reactReduxForwardedRef
          }))
        );
      }, [reactReduxForwardedRef, WrappedComponent, actualChildProps]);
      const renderedChild = (0, import_react4.useMemo)(() => {
        if (shouldHandleStateChanges) {
    ...
    const _Connect = import_react4.default.memo(ConnectFunction);
    const Connect = _Connect;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = ConnectFunction.displayName = displayName;
    if (forwardRef) {
      const _forwarded = import_react4.default.forwardRef(function forwardConnectRef(props, ref) {
...
function createSelectorHook(context = ReactReduxContext) {
  ...
  return function useSelector2(selector, equalityFnOrOptions = {}) {
    ...
    const firstRun = (0, import_react6.useRef)(true);
    const wrappedSelector = (0, import_react6.useCallback)({
      [selector.name](state) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NB36UYGV.js.map
